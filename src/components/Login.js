            ...
            <div className="card bg-transparent card-blur" style={{ padding: '20px' }}>
              ...
              <form>
                <div className="form-group mx-3" >
                  <input type="text" className="form-control login-input" style={{ backgroundColor: 'transparent',color:'white', borderTop: '1px',id:'username' ,borderRight: '1px', borderLeft: '1px' }} placeholder="Username or e-mail" />
                </div>
                ...
                <Link className="d-flex justify-content-center" to="/Signup">
                  <button type="submit" className="btn btn-primary login-button mx-3 my-2 " style={{ width: '100%', background: 'white', color: 'black', borderRadius: '100px' }}><strong>Create your new  account</strong></button>
                </Link>
              </form>
              <div className="d-flex justify-content-center" style={{ color: 'black' }}>
